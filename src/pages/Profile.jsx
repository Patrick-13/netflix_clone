    ...
    <>
      <div>
        <img
          ...
          src="https://assets.nflxext.com/ffe/siteui/vlv3/4da5d2b1-1b22-498d-90c0-4d86701dffcc/c79d4530-2e06-4066-adfc-ac31fc9619d5/PH-en-20240129-popsignuptwoweeks-perspective_alpha_website_large.jpg"
          alt="///"
        />
        <div className="bg-black/60 fixed top-0 left-0 w-full h-[500px]">
          <div className="absolute top-[20%] p-4 md:p-8">
            <h1 className="text-3xl nd:text-5xl font-nsans-bold my-2">
              My Favorite Shows
            </h1>
